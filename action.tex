...
If the publisher hosts user content:
\lm{Should publishers be responsible for handling things like user generated content, where user generated content is the corepart of the game.
Should they be responsible for allowing ``sideloading'' of such content?
Political suggestions around sideloading already happening}
