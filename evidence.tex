...
Games could be partially functional, for example retaining a single player version of the game but losing access to features within it like online leaderboards.
...
\subsection{Retaining Single Player}
