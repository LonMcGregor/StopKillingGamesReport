...
\lm{An illustrative case study where a popular game that did not have to die, did}

\subsection{Loss of User Generated Content}
\lm{Case study a game where the core gameplay comes from user generated content, levels, etc,
where the publisher retains responsibility for sharing this,
and when this is shut down, the game is effectively unplayable.
Little Big Planet, Mario Maker}

\subsection{Loss of connective services}
\lm{Example of games where console / other non-mp-server third party connecting services have been disabled, resulting in loss of a game}
